...
use domain::models::{Business,Invoice};
...
#[openapi(
    paths(
        ...
        business::list_business_handler,
        business::create_business_handler,
        business::update_business_handler,
        business::delete_business_handler,
        invoice::list_invoices_handler,
        invoice::list_invoice_handler,
        invoice::create_invoice_handler,
        invoice::update_invoice_handler,
        invoice::delete_invoice_handler
    ),
    components(schemas(Business,Invoice))
)]
pub struct ApiDoc;
